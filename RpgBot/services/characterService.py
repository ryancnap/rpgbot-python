...
class CharacterService():
    ...
    async def DescribeCharacter(self, player:str):
        ...
        return {
            ...
            "HP": f"{character.CurrentHP} / {character.MaxHP}",
            "AP": f"{character.CurrentAP} / {character.MaxAP}",
            "Inventory": f"{len(character.Inventory.Stored)} / {character.MaxInventory}",
            "Abilities": f"{len(character.Inventory.Ability)} / {character.MaxAbilities}",
            "Attributes": {
